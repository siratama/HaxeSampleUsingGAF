...
extern class QuadBatch extends DisplayObject {
	var batchable : Bool;
	var capacity : Int;
	var forceTinted : Bool;
	var numQuads(default,never) : Int;
	var ownsTexture : Bool;
	...
	function renderCustom(p1 : flash.geom.Matrix3D, p2 : Float = 1, ?p3 : String) : Void;
	function reset() : Void;
	function setQuad(p1 : Float, p2 : Quad) : Void;
	...
	static function optimize(p1 : flash.Vector<QuadBatch>) : Void;
}
