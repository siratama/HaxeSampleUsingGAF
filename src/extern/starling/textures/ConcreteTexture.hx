...
extern class ConcreteTexture extends Texture {
	...
	function attachCamera(p1 : flash.media.Camera, ?p2 : flash.utils.Function) : Void;
	function attachNetStream(p1 : flash.net.NetStream, ?p2 : flash.utils.Function) : Void;
	function attachVideo(p1 : String, p2 : flash.utils.Object, ?p3 : flash.utils.Function) : Void;
