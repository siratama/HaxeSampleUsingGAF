...
extern class GroupedList extends Scroller implements feathers.core.IFocusContainer {
	...
	var lastItemRendererName : String;
	...
	var singleItemRendererName : String;
	...
	static var ALTERNATE_CHILD_NAME_INSET_FIRST_ITEM_RENDERER : String;
	static var ALTERNATE_CHILD_NAME_INSET_FOOTER_RENDERER : String;
	static var ALTERNATE_CHILD_NAME_INSET_HEADER_RENDERER : String;
	static var ALTERNATE_CHILD_NAME_INSET_ITEM_RENDERER : String;
	static var ALTERNATE_CHILD_NAME_INSET_LAST_ITEM_RENDERER : String;
	static var ALTERNATE_CHILD_NAME_INSET_SINGLE_ITEM_RENDERER : String;
	...
	static var ALTERNATE_NAME_INSET_GROUPED_LIST : String;
	...
	static var DEFAULT_CHILD_NAME_FOOTER_RENDERER : String;
	static var DEFAULT_CHILD_NAME_HEADER_RENDERER : String;
