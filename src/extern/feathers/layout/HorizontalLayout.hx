...
extern class HorizontalLayout extends starling.events.EventDispatcher implements ITrimmedVirtualLayout implements IVariableVirtualLayout {
	var afterVirtualizedItemCount : Int;
	var beforeVirtualizedItemCount : Int;
	var distributeWidths : Bool;
	var firstGap : Float;
	var gap : Float;
	...
	var scrollPositionHorizontalAlign : String;
